...
namespace WPAirlineManager4\Cache;
...
function get_cache_time( $min = HOUR_IN_SECONDS * 11, $max = HOUR_IN_SECONDS * 12 ) {
	...
	return apply_filters( 'wp_am4_get_cache_time', mt_rand( $min, $max ) );
}
