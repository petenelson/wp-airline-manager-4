 ...
 */
class WPAM4_Unit_Tests_Bootstrap {
	...
	public function manually_load_plugin() {
		require $this->plugin_root . '/wp-airline-manager-4.php';
	}
}

$wp_am4_unit_tests = new WPAM4_Unit_Tests_Bootstrap();
$wp_am4_unit_tests->bootstrap();
